...
import { Mail, Lock, User, Eye, EyeOff, CircleCheck as CheckCircle, Calendar, FileText } from 'lucide-react-native';
...
export default function SignUpScreen() {
                  ...
                  <View style={styles.form}>
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      <View style={styles.inputContainer}>
                        <User size={20} color={DesignSystem.colors.text.secondary} />
                        <TextInput
                          style={styles.input}
  ...
  // Desktop/Tablet layout with Bento design
  return (
    <LinearGradient
      colors={['#667eea', '#764ba2']}
            ...
            <BlurView intensity={20} tint="light" style={styles.formBlurDesktop}>
              ...
              >
                <View style={styles.formHeader}>
                  ...
                  <Text style={styles.formSubtitle}>Join S.A.F.E. Meds today</Text>
                </View>
